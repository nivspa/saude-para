    ...
    <LanguageProvider>
      <Router>
        <Routes>
          ...
          <Route
            path="/vigilancia-sanitaria"
            element={<DepartmentForm department="vigilancia-sanitaria" />}
          />
          <Route
            path="/acidentes"
            element={<DepartmentForm department="acidentes" />}
          />
          <Route
            path="/doencas-cronicas"
            element={<DepartmentForm department="doencas-cronicas" />}
          />
          <Route
            path="/saude-mental"
            element={<DepartmentForm department="saude-mental" />}
          />
          <Route
            path="/doencas-infecciosas"
            element={<DepartmentForm department="doencas-infecciosas" />}
          />
          <Route
            path="/zoonoses"
            element={<DepartmentForm department="zoonoses" />}
          />
          <Route
            path="/medicamentos"
            element={<DepartmentForm department="medicamentos" />}
          />
          <Route
            path="/materno-infantil"
            element={<DepartmentForm department="materno-infantil" />}
          />
          <Route
            path="/epidemiologia"
            element={<DepartmentForm department="epidemiologia" />}
          />
          <Route
            path="/campanha-vacinacao-covid"
            element={<CampanhaVacinacaoCovid />}
          />
          <Route
            path="/campanha-vacinacao-covid"
            element={<CampanhaVacinacaoCovid />}
          />
          <Route
            path="/campanha-dezembro-vermelho"
            element={<DezembroVermelho />}
          />
